...
ages <- read_csv(here::here("Week 2", "Preview Activity", "Ages_Data", "ages.csv"))
...
ages_tab <- read_tsv(here::here("Week 2", "Preview Activity", "Ages_Data", "ages_tab.txt"))
...
ages_mystery <- read_delim(here::here("Week 2", "Preview Activity", "Ages_Data", "ages_mystery.txt"))
...
ages_xlsx <- read_excel(here::here("Week 2", "Preview Activity", "Ages_Data", "ages.xlsx"))
...
ages_factor <- read_csv("ages.csv", stringsAsFactors = TRUE)
